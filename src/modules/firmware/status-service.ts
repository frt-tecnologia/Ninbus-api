 ...
 *
 * All reads are DB-ONLY (no hawkBit calls): device versions come from
 * `devices.firmwareVersion` (synced from DDI attributes by the sync engine)
 * and the "latest" comes from the factory `firmware_releases` catalog.
 */
